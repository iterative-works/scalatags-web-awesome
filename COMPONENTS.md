...
| wa-zoomable-frame | [x] | [x] | [x] | [x] | zoom, zoom-levels, without-controls, without-interaction |

## Observers (utility components)

| Component | Tag | Scenario | Attrs | Review | WA-specific attrs needed |
|-----------|-----|----------|-------|--------|--------------------------|
| wa-intersection-observer | [x] | [x] | [x] | [x] | root, root-margin, threshold, intersect-class, once |
| wa-mutation-observer | [x] | [x] | [x] | [x] | attr, attr-old-value, char-data, char-data-old-value, child-list |
| wa-resize-observer | [x] | [x] | [x] | [x] | (none) |
| wa-scroller | [x] | [x] | [x] | [x] | orientation |

## Pro Components

| Component | Tag | Scenario | Attrs | Review | WA-specific attrs needed |
|-----------|-----|----------|-------|--------|--------------------------|
| wa-combobox | [x] | [x] | [x] | [x] | max-options-visible, with-clear, open, placement, with-label, with-hint, allow-custom-value |
| wa-file-input | [x] | [x] | [x] | [x] | with-label, with-hint |
| wa-page | [x] | [x] | [x] | [x] | view, nav-open, mobile-breakpoint, navigation-placement, disable-navigation-toggle |
| wa-sparkline | [x] | [x] | [x] | [x] | trend, curve (data conflicts with scalatags — use attr("data")) |
