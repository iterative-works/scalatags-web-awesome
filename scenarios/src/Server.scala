...
object Server extends cask.MainRoutes:
    ...
    def copyButtonPage(): cask.Response[String] = htmlPage("Copy Button", "copy-button")(
        ...
        div(cls := "demo-section")(
            ...
            div(attr(
                "style"
            ) := "background: #f5f5f5; padding: 1rem; border-radius: 4px; position: relative")(
    ...
    def breadcrumbItemPage(): cask.Response[String] =
        htmlPage("Breadcrumb Item", "breadcrumb-item")(
        ...
        div(cls := "demo-section")(
            ...
            div(style := "height: 300px; border: 1px solid #ccc;")(
                waSplitPanel(
                    ...
                    div(slot := "end", style := "padding: 1rem; background: #e0e0e0;")(
                        "End panel content"
                    )
                )
            )
            ...
            div(style := "height: 400px; border: 1px solid #ccc;")(
                waSplitPanel(
                    ...
                    waSplitPanel(slot := "end", orientation := "vertical")(
                        div(slot := "start", style := "padding: 1rem; background: #e8e8e8;")(
                            "Top content area"
                        ),
                        div(slot := "end", style := "padding: 1rem; background: #d0d0d0;")(
                            "Bottom content area"
                        )
                    )
                )
    ...
    def checkboxPage(): cask.Response[String] = htmlPage("Checkbox", "checkbox")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waCheckbox(indeterminate := "true", attr("checked") := "true")(
    ...
    def colorPickerPage(): cask.Response[String] = htmlPage("Color Picker", "color-picker")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waColorPicker(
                    attr("label") := "With opacity slider",
                    attr("opacity") := "true",
                    value := "#ff6b3580"
                ),
                waColorPicker(
                    attr("label") := "RGBA format",
                    format := "rgb",
                    attr("opacity") := "true",
                    value := "rgba(255, 107, 53, 0.5)"
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waColorPicker(
                    attr("label") := "Uppercase",
                    uppercase := "true",
                    value := "#95E1D3"
                ),
                waColorPicker(
                    attr("label") := "Without format toggle",
                    withoutFormatToggle := "true",
                    value := "#f38181"
                ),
                waColorPicker(
                    attr("label") := "Open by default",
                    attr("open") := "true",
                    value := "#aa96da"
                )
            )
    ...
    def radioPage(): cask.Response[String] = htmlPage("Radio", "radio")(
        ...
        div(cls := "demo-section")(
            ...
            waRadioGroup(attr("label") := "Disabled options", name := "disabled")(
                ...
                waRadio(value := "opt3", disabled := "true", attr("checked") := "true")(
                    "Disabled & checked"
                )
            )
        ),
    ...
    def textareaPage(): cask.Response[String] = htmlPage("Textarea", "textarea")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waTextarea(
                    attr("label") := "Default rows",
                    placeholder := "Default height (3 rows)"
                ),
                waTextarea(
                    attr("label") := "More rows",
                    rows := "8",
    ...
    def dropdownItemPage(): cask.Response[String] = htmlPage("Dropdown Item", "dropdown-item")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waDropdown(
                    ...
                    waDropdownItem(`type` := "checkbox", attr("checked") := "true")(
                        "Show notifications"
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waDropdown(
                    ...
                    waDropdownItem(
                        "Document.pdf",
                        tag("small")(slot := "details", attr("style") := "color: #666")(
                            "2 hours ago"
                        )
                    ),
                    waDropdownItem(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waDropdown(
                    waButton(slot := "trigger", variant := "brand", withCaret := "true")(
                        "User Menu"
                    ),
                    waDropdownItem(
    ...
    def dropdownPage(): cask.Response[String] = htmlPage("Dropdown", "dropdown")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waDropdown(
                    tag("button")(
                        slot := "trigger",
                        attr("style") := "padding: 0.5rem 1rem; cursor: pointer"
                    )("Native Button"),
                    waDropdownItem("Option A"),
                    waDropdownItem("Option B")
                ),
                waDropdown(
                    a(slot := "trigger", href := "#", attr("style") := "text-decoration: none")(
                        "Link trigger"
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waDropdown(
                    waButton(slot := "trigger", attr("size") := "small", withCaret := "true")(
                        "Small"
                    ),
                ...
                waDropdown(
                    waButton(slot := "trigger", attr("size") := "medium", withCaret := "true")(
                        "Medium"
                    ),
                ...
                waDropdown(
                    waButton(slot := "trigger", attr("size") := "large", withCaret := "true")(
                        "Large"
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waDropdown(placement := "top-end", distance := "15", skidding := "30")(
                    waButton(slot := "trigger", variant := "success", withCaret := "true")(
                        "Custom Position"
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(attr("style") := "display: flex; align-items: center; gap: 0.75rem")(
                    ...
                    div(
                        div(strong("John Doe")),
                        div(attr("style") := "color: #666; font-size: 0.875rem")(
                            "Software Engineer"
                        )
                    )
                ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waAnimation(
                    ...
                    div(attr(
                        "style"
                    ) := "width: 100px; height: 100px; background: #0066ff; border-radius: 8px")
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waAnimation(
                    ...
                    div(attr(
                        "style"
                    ) := "width: 80px; height: 80px; background: #28a745; border-radius: 50%")
                ),
                waAnimation(
                    attr("name") := "shake",
                    duration := "1000",
                    ...
                    div(attr(
                        "style"
                    ) := "width: 80px; height: 80px; background: #dc3545; border-radius: 8px")
                ),
                waAnimation(
                    attr("name") := "spin",
                    duration := "2000",
                    ...
                    div(attr(
                        "style"
                    ) := "width: 80px; height: 80px; background: #ffc107; border-radius: 8px")
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waAnimation(
                    ...
                    div(
                        attr("style") := "width: 60px; height: 60px; background: #6f42c1; border-radius: 8px; margin-right: 20px"
                    )(
                        div(
                            attr("style") := "font-size: 0.7rem; color: white; text-align: center; padding-top: 20px"
                        )("0.5s")
                    )
                ),
                waAnimation(
                ...
                waAnimation(
                    ...
                    div(attr(
                        "style"
                    ) := "width: 60px; height: 60px; background: #6f42c1; border-radius: 8px")(
                        div(
                            attr("style") := "font-size: 0.7rem; color: white; text-align: center; padding-top: 20px"
                        )("2s")
                    )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waAnimation(
                    ...
                    div(
                        attr("style") := "width: 70px; height: 70px; background: #17a2b8; border-radius: 8px; margin-right: 15px"
                    )(
                        div(
                            attr("style") := "font-size: 0.65rem; color: white; text-align: center; padding-top: 22px"
                        )("linear")
                    )
                ),
                waAnimation(
                    ...
                    div(attr(
                        "style"
                    ) := "width: 70px; height: 70px; background: #17a2b8; border-radius: 8px")(
                        div(
                            attr("style") := "font-size: 0.6rem; color: white; text-align: center; padding-top: 20px"
                        )("ease-in-out")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waAnimation(
                    ...
                    div(
                        attr("style") := "width: 70px; height: 70px; background: #fd7e14; border-radius: 8px; margin-right: 15px"
                    )(
                        div(
                            attr("style") := "font-size: 0.65rem; color: white; text-align: center; padding-top: 22px"
                        )("normal")
                ...
                waAnimation(
                    ...
                    div(attr(
                        "style"
                    ) := "width: 70px; height: 70px; background: #fd7e14; border-radius: 8px")(
                        div(
                            attr("style") := "font-size: 0.6rem; color: white; text-align: center; padding-top: 22px"
                        )("alternate")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waAnimation(
                    ...
                    div(
                        attr("style") := "width: 60px; height: 60px; background: #e83e8c; border-radius: 50%; margin-right: 20px"
                    )(
                        div(
                            attr("style") := "font-size: 0.65rem; color: white; text-align: center; padding-top: 20px"
                        )("0ms")
                    )
                ),
                waAnimation(
                ...
                waAnimation(
                    ...
                    div(attr(
                        "style"
                    ) := "width: 60px; height: 60px; background: #e83e8c; border-radius: 50%")(
                        div(
                            attr("style") := "font-size: 0.6rem; color: white; text-align: center; padding-top: 20px"
                        )("1000ms")
                    )
    ...
    def calloutPage(): cask.Response[String] = htmlPage("Callout", "callout")(
        ...
        div(cls := "demo-section")(
            ...
            waCallout(variant := "brand", appearance := "filled")(
                ...
                p(attr("style") := "margin: 0.5rem 0")(
                    "Try our new dashboard redesign with improved analytics and reporting."
                ),
                div(slot := "footer")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waPopover(attr("for") := "popover-rich", placement := "top")(
                    ...
                    p(attr("style") := "margin: 0.5rem 0")(
                        "This product includes all the features you need."
                    ),
    ...
    def popupPage(): cask.Response[String] = htmlPage("Popup", "popup")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                span(
                    id := "popup-anchor-1",
                    attr("style") := "display: inline-block; padding: 0.5rem 1rem; background: #0066ff; color: white; border-radius: 4px; cursor: pointer"
                )(
                    "Hover me"
                ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                span(
                    id := "popup-top",
                    attr("style") := "display: inline-block; padding: 0.5rem; background: #eee; border-radius: 4px; margin: 0.5rem"
                )(
                    "Top"
                ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                span(
                    id := "popup-arrow",
                    attr("style") := "display: inline-block; padding: 0.5rem 1rem; background: #0066ff; color: white; border-radius: 4px"
                )(
                    "Arrow popup"
                ),
                waPopup(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                span(
                    id := "popup-flip",
                    attr("style") := "display: inline-block; padding: 0.5rem; background: #eee; border-radius: 4px"
                )(
                    "Flip enabled"
                ),
                waPopup(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                span(
                    id := "popup-sync",
                    attr("style") := "display: inline-block; padding: 0.5rem; background: #0066ff; color: white; border-radius: 4px; width: 200px"
                )(
                    "Wide anchor element"
                ),
                waPopup(
    ...
    def tooltipPage(): cask.Response[String] = htmlPage("Tooltip", "tooltip")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    attr("style") := "overflow: hidden; padding: 1rem; border: 1px solid #ccc; display: inline-block"
                )(
    ...
    def skeletonPage(): cask.Response[String] = htmlPage("Skeleton", "skeleton")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(attr("style") := "display: flex; flex-direction: column; gap: 1rem")(
                    div(
                        p(attr("style") := "margin-bottom: 0.5rem; font-size: 0.875rem")(
                            "None (default)"
                        ),
        ...
        div(cls := "demo-section")(
            ...
            div(attr(
                "style"
            ) := "display: flex; flex-direction: column; gap: 0.75rem; max-width: 500px")(
                ...
                waCard(
                    div(attr("style") := "padding: 1rem")(
                        div(attr("style") := "display: flex; gap: 1rem; margin-bottom: 1rem")(
                            ...
                            div(
                                attr("style") := "flex: 1; display: flex; flex-direction: column; gap: 0.5rem; justify-content: center"
                            )(
                                waSkeleton(
                                    effect := "sheen",
                                    attr("style") := "width: 70%; height: 16px"
                                ),
                                waSkeleton(
                                    effect := "sheen",
                                    attr("style") := "width: 50%; height: 14px"
                                )
                            )
                        ),
                        waSkeleton(
                            effect := "pulse",
                            attr("style") := "width: 100%; height: 200px; border-radius: 8px; margin-bottom: 1rem"
                        ),
                        div(attr("style") := "display: flex; flex-direction: column; gap: 0.5rem")(
                            waSkeleton(
                                effect := "sheen",
                                attr("style") := "width: 100%; height: 14px"
                            ),
                            waSkeleton(
                                effect := "sheen",
                                attr("style") := "width: 95%; height: 14px"
                            ),
                            waSkeleton(
                                effect := "sheen",
                                attr("style") := "width: 85%; height: 14px"
                            )
                        )
                    )
                )
        ...
        div(cls := "demo-section")(
            ...
            div(attr(
                "style"
            ) := "display: flex; flex-direction: column; gap: 1rem; max-width: 500px")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waSkeleton(
                    effect := "pulse",
                    attr("style") := "width: 100px; height: 36px; border-radius: 6px"
                ),
                waSkeleton(
                    effect := "pulse",
                    attr("style") := "width: 120px; height: 36px; border-radius: 6px"
                ),
                waSkeleton(
                    effect := "pulse",
                    attr("style") := "width: 80px; height: 36px; border-radius: 6px"
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(attr(
                ...
                div(attr(
                    "style"
                ) := "display: grid; grid-template-columns: 2fr 1fr 1fr 100px; gap: 1rem")(
        ...
        div(cls := "demo-section")(
            ...
            div(attr(
                ...
                div(
                    p(attr(
                        "style"
                    ) := "margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 500")("Name"),
                    waSkeleton(
                        effect := "pulse",
                        attr("style") := "width: 100%; height: 40px; border-radius: 6px"
                    )
                ),
                div(
                    p(attr(
                        "style"
                    ) := "margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 500")("Email"),
                    waSkeleton(
                        effect := "pulse",
                        attr("style") := "width: 100%; height: 40px; border-radius: 6px"
                    )
                ...
                div(
                    p(attr(
                        "style"
                    ) := "margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 500")("Message"),
                    waSkeleton(
                        effect := "pulse",
                        attr("style") := "width: 100%; height: 100px; border-radius: 6px"
                    )
                ),
                waSkeleton(
                    effect := "pulse",
                    attr("style") := "width: 120px; height: 40px; border-radius: 6px"
                )
            )
        )
    )
    ...
    def spinnerPage(): cask.Response[String] = htmlPage("Spinner", "spinner")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waSpinner(
                    attr("style") := "--track-color: rgba(0, 102, 255, 0.2); --indicator-color: #0066ff; font-size: 2rem"
                ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waButton(variant := "danger", loading := "true", attr("size") := "small")(
                    "Deleting"
                ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    attr("style") := "display: flex; flex-direction: column; align-items: center; gap: 0.75rem; padding: 2rem; background: #f5f5f5; border-radius: 8px"
                )(
                    waSpinner(attr("style") := "font-size: 2rem"),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waCard(attr("style") := "width: 300px")(
                    ...
                    div(
                        attr("style") := "display: flex; flex-direction: column; align-items: center; padding: 3rem 1rem"
                    )(
                        waSpinner(attr("style") := "font-size: 2.5rem; margin-bottom: 1rem"),
                        p(attr("style") := "margin: 0; color: #666; text-align: center")(
                            "Fetching your data..."
                        )
                    )
                ),
                waCard(attr("style") := "width: 300px")(
                    ...
                    div(
                        ...
                        waSpinner(attr(
                            "style"
                        ) := "--indicator-color: #0066ff; font-size: 2.5rem; margin-bottom: 1rem"),
                        p(attr("style") := "margin: 0; color: #666; text-align: center")(
                            "Uploading files..."
                        ),
                        p(
                            attr(
                                "style"
                            ) := "margin: 0.5rem 0 0 0; color: #999; font-size: 0.875rem"
                        )("75% complete")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waSpinner(
                    attr("style") := "--indicator-color: #0066ff; --track-color: rgba(0, 102, 255, 0.15); --track-width: 4px; --speed: 1.5s; font-size: 3rem"
                ),
                waSpinner(
                    attr("style") := "--indicator-color: #28a745; --track-color: rgba(40, 167, 69, 0.15); --track-width: 3px; --speed: 0.8s; font-size: 3rem"
                ),
                waSpinner(
                    attr("style") := "--indicator-color: #dc3545; --track-color: transparent; --track-width: 5px; --speed: 1s; font-size: 3rem"
                )
            )
        ),
        div(cls := "demo-section")(
            h2("Dark background"),
            div(
                attr("style") := "background: #1a1a2e; padding: 2rem; border-radius: 8px; display: flex; gap: 2rem; justify-content: center"
            )(
                waSpinner(
                    attr("style") := "--indicator-color: #ffffff; --track-color: rgba(255, 255, 255, 0.2); font-size: 2rem"
                ),
                waSpinner(
                    attr("style") := "--indicator-color: #4ecdc4; --track-color: rgba(78, 205, 196, 0.2); font-size: 2rem"
                ),
                waSpinner(
                    attr("style") := "--indicator-color: #ff6b6b; --track-color: rgba(255, 107, 107, 0.2); font-size: 2rem"
                ),
                waSpinner(
                    attr("style") := "--indicator-color: #ffe66d; --track-color: rgba(255, 230, 109, 0.2); font-size: 2rem"
                )
            )
        )
    )
    ...
    def tagPage(): cask.Response[String] = htmlPage("Tag", "tag")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waTag(withRemove := "true", attr("size") := "small", variant := "brand")(
                    "Small removable"
                ),
                waTag(withRemove := "true", attr("size") := "medium", variant := "brand")(
                    "Medium removable"
                ),
                waTag(withRemove := "true", attr("size") := "large", variant := "brand")(
                    "Large removable"
                )
            )
        ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waCarousel(attr("style") := "width: 600px; height: 400px;")(
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 2rem"
                        )("Slide 1")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 2rem"
                        )("Slide 2")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 2rem"
                        )("Slide 3")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 2rem"
                        )("Slide 4")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waCarousel(
                    ...
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem"
                        )("Auto-playing 1")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #30cfd0 0%, #330867 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem"
                        )("Auto-playing 2")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); display: flex; align-items: center; justify-content: center; color: #333; font-size: 1.5rem"
                        )("Auto-playing 3")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waCarousel(
                    ...
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: #ff6b6b; display: flex; align-items: center; justify-content: center; color: white"
                        )("1")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: #4ecdc4; display: flex; align-items: center; justify-content: center; color: white"
                        )("2")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: #45b7d1; display: flex; align-items: center; justify-content: center; color: white"
                        )("3")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: #96ceb4; display: flex; align-items: center; justify-content: center; color: white"
                        )("4")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: #ffeaa7; display: flex; align-items: center; justify-content: center; color: #333"
                        )("5")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: #dfe6e9; display: flex; align-items: center; justify-content: center; color: #333"
                        )("6")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waCarousel(
                    ...
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(180deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem"
                        )("Vertical 1")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(180deg, #f093fb 0%, #f5576c 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem"
                        )("Vertical 2")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(180deg, #4facfe 0%, #00f2fe 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem"
                        )("Vertical 3")
                    )
                )
            )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waCarousel(
                    ...
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.2rem"
                        )("Drag me!")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.2rem"
                        )("Drag to navigate")
                    ),
                    waCarouselItem(
                        div(
                            attr("style") := "width: 100%; height: 100%; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.2rem"
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "Short (default): ",
                        waFormatBytes(value := "1048576", attr("display") := "short")
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "  Short: ",
                        waFormatBytes(value := "1000000000", attr("display") := "short")
                    ),
                    p(
                        "  Narrow: ",
                        waFormatBytes(value := "1000000000", attr("display") := "narrow")
                    )
                )
            )
        )
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "With weekday: ",
                        waFormatDate(date := "2024-01-15T09:30:00", weekday := "long")
                    ),
                    p(
                        "Short weekday: ",
                        waFormatDate(date := "2024-01-15T09:30:00", weekday := "short")
                    )
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "Month/Day only: ",
                        waFormatDate(date := "2024-01-15", month := "long", day := "numeric")
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "Without grouping: ",
                        waFormatNumber(value := "1234567.89", withoutGrouping := "true")
                    )
                )
            )
        ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "Min 2 on integer: ",
                        waFormatNumber(value := "1234", minimumFractionDigits := "2")
                    )
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "Min 6 digits: ",
                        waFormatNumber(value := "1234", minimumIntegerDigits := "6")
                    )
                )
            )
        ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "0.25 as percent: ",
                        waFormatNumber(value := "0.25", attr("type") := "percent")
                    ),
                    p(
                        "0.5 as percent: ",
                        waFormatNumber(value := "0.5", attr("type") := "percent")
                    ),
                    p(
                        "1.5 as percent: ",
                        waFormatNumber(value := "1.5", attr("type") := "percent")
                    ),
                    p(
                        "0.1234 with 2 decimals: ",
                        waFormatNumber(
                            value := "0.1234",
                            attr("type") := "percent",
                            minimumFractionDigits := "2",
    ...
    def relativeTimePage(): cask.Response[String] = htmlPage("Relative Time", "relative-time")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    ...
                    p(
                        "1 hour ago: ",
                        waRelativeTime(date := java.time.Instant.now().minusSeconds(3600).toString)
                    ),
                    p(
                        "1 day ago: ",
                        waRelativeTime(date := java.time.Instant.now().minusSeconds(86400).toString)
                    ),
                    p(
                        "1 week ago: ",
                        waRelativeTime(
                            date := java.time.Instant.now().minusSeconds(604800).toString
                        )
                    ),
                    p(
                        "1 month ago: ",
                        waRelativeTime(
                            date := java.time.Instant.now().minusSeconds(2592000).toString
                        )
                    )
                )
            )
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "Long (default): ",
                        waRelativeTime(
                            date := java.time.Instant.now().minusSeconds(3600).toString,
                            format := "long"
                        )
                    ),
                    p(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "Auto (yesterday/tomorrow): ",
                        waRelativeTime(
                            date := java.time.Instant.now().minusSeconds(86400).toString,
                            numeric := "auto"
                        )
                    ),
                    p(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "Static (default): ",
                        waRelativeTime(date := java.time.Instant.now().toString, sync := "false")
                    ),
                    p(
                        "Synced (live updates): ",
                        waRelativeTime(date := java.time.Instant.now().toString, sync := "true")
                    )
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "In 1 hour: ",
                        waRelativeTime(date := java.time.Instant.now().plusSeconds(3600).toString)
                    ),
                    p(
                        "In 1 day: ",
                        waRelativeTime(date := java.time.Instant.now().plusSeconds(86400).toString)
                    ),
                    p(
                        "In 1 week: ",
                        waRelativeTime(date := java.time.Instant.now().plusSeconds(604800).toString)
                    )
                )
            )
        )
    ...
    def includePage(): cask.Response[String] = htmlPage("Include", "include")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "The wa-include component fetches HTML from a remote source and includes it in the page."
                    ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(raw(
                        "⚠️ Be sure you trust the content you are including as it will be executed as code and can result in XSS attacks."
                    )),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waQrCode(
                    value := "https://webawesome.com",
                    fill := "#ff0066",
                    attr("background") := "#ffe0f0"
                ),
                waQrCode(
                    value := "https://webawesome.com",
                    fill := "#00cc66",
                    attr("background") := "#e0ffe0"
                ),
                waQrCode(
                    value := "https://webawesome.com",
                    fill := "#ffffff",
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                div(
                    p(
                        "L (Low): ",
                        waQrCode(value := "https://webawesome.com", errorCorrection := "L")
                    ),
                    p(
                        "M (Medium): ",
                        waQrCode(value := "https://webawesome.com", errorCorrection := "M")
                    ),
                    p(
                        "Q (Quartile): ",
                        waQrCode(value := "https://webawesome.com", errorCorrection := "Q")
                    ),
                    p(
                        "H (High): ",
                        waQrCode(value := "https://webawesome.com", errorCorrection := "H")
                    )
                )
            )
        ),
    ...
    def intersectionObserverPage(): cask.Response[String] =
        htmlPage("Intersection Observer", "intersection-observer")(
    ...
    def mutationObserverPage(): cask.Response[String] =
        htmlPage("Mutation Observer", "mutation-observer")(
        ...
        """
                ...
                div(cls := "demo-row")(
                    waMutationObserver(attr("attr") := "class style", attrOldValue := "true")(
                        ...
                        div(slot := "mutated", cls := "log", id := "attr-log")(
                            "Waiting for changes..."
                        )
                    )
                ),
            ...
            div(cls := "demo-section")(
                ...
                div(cls := "demo-row")(
                    waMutationObserver(childList := "true")(
                        div(id := "child-target", cls := "target")(
                            "Click button to add/remove children"
                        ),
                        div(slot := "mutated", cls := "log", id := "child-log")(
                            "Waiting for changes..."
                        )
                    )
                ),
            ...
            div(cls := "demo-section")(
                ...
                div(cls := "demo-row")(
                    waMutationObserver(charData := "true", charDataOldValue := "true")(
                        ...
                        div(slot := "mutated", cls := "log", id := "char-log")(
                            "Waiting for changes..."
                        )
                    )
                ),
            ...
            div(cls := "demo-section")(
                ...
                div(cls := "demo-row")(
                    waMutationObserver(childList := "true", disabled := true)(
                        ...
                        div(slot := "mutated", cls := "log")(
                            "Observer is disabled - no mutations will be logged"
                        )
                    )
                )
            )
    ...
    def resizeObserverPage(): cask.Response[String] =
        htmlPage("Resize Observer", "resize-observer")(
      ...
      """
            ...
            div(cls := "demo-section")(
                ...
                p(
                    "Drag the corner of the box below to resize it. The observer will detect size changes."
                ),
                div(cls := "demo-row")(
                    waResizeObserver(
                        div(id := "basic-box", cls := "resizable-box")("Resize me!"),
                        div(slot := "resized", id := "basic-display", cls := "size-display")(
            ...
            div(cls := "demo-section")(
                ...
                div(cls := "demo-row")(
                    waResizeObserver(
                        ...
                        div(slot := "resized", id := "resize-log", cls := "resize-log")(
            ...
            div(cls := "demo-section")(
                ...
                div(cls := "demo-row")(
                    waResizeObserver(disabled := true)(
                        ...
                        div(slot := "resized", cls := "size-display")(
                            "Observer is disabled - resize events will not be detected"
                        )
                    )
                )
            )
    ...
    def sparklinePage(): cask.Response[String] = htmlPage("Sparkline", "sparkline")(
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                ...
                waSparkline(
                    attr("data") := "60 50 40 30 20 10",
                    attr("label") := "Declining trend"
                ),
        ...
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waSparkline(
                    attr("data") := "10 20 30 40 50 60",
                    trend := "positive",
                    attr("label") := "Positive trend"
                ),
                waSparkline(
                    attr("data") := "60 50 40 30 20 10",
                    trend := "negative",
                    attr("label") := "Negative trend"
                ),
                waSparkline(
                    attr("data") := "30 30 30 30 30 30",
                    trend := "neutral",
                    attr("label") := "Neutral trend"
                )
            )
        ),
        div(cls := "demo-section")(
            ...
            div(cls := "demo-row")(
                waSparkline(
                    attr("data") := "10 30 20 40 35 50",
                    curve := "linear",
                    attr("label") := "Linear curve"
                ),
                waSparkline(
                    attr("data") := "10 30 20 40 35 50",
                    curve := "natural",
                    attr("label") := "Natural curve"
                ),
                waSparkline(
                    attr("data") := "10 30 20 40 35 50",
                    curve := "step",
                    attr("label") := "Step curve"
                )
            )
        ),
        div(cls := "demo-section")(
